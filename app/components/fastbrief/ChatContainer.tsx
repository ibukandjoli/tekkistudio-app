...
const INITIAL_MESSAGE: ChatMessage = {
    id: 'msg-init-1',
    role: 'assistant',
    content: "Bonjour ! Je suis l'assistant IA de TEKKI Studio. Notre but est de transformer votre marque en une machine de vente autonome. Mais avant ça, j'ai besoin d'auditer votre modèle. Cela prend 3 minutes. Pour commencer, quel est le nom de votre marque et votre spécialité (skincare, capillaire, etc.) ?"
};
