...
const INITIAL_MESSAGE: ChatMessage = {
    id: 'msg-init-1',
    role: 'assistant',
    content: "Bonjour ! Je suis l'assistant AI de TEKKI Studio. Avant de vous proposer une infrastructure e-commerce sur mesure, j'ai besoin de comprendre les rouages de votre marque. Cela prend 3 minutes.\n\nPour commencer, quel est le nom de votre marque et quelle est votre spécialité (skincare, capillaire, etc.) ?"
};
...
export function ChatContainer() {
    ...
    return (
        <div className="fixed inset-0 z-[100] bg-[#f9fafb] flex flex-col w-full h-[100dvh]">
            {/* Header */}
            <div className="flex-shrink-0 bg-white border-b border-gray-200 px-4 py-3 flex items-center justify-between shadow-sm z-10 w-full">
