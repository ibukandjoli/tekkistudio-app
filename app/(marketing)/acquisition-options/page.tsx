  ...
  return (
    <main className="pb-0">
      ...
      <section className="bg-tekki-blue relative pt-28 pb-20 overflow-hidden">
        ...
        <Container className="relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 bg-tekki-orange/15 border border-tekki-orange/30 rounded-full px-5 py-2.5 mb-6">
              <span className="text-tekki-orange text-sm font-semibold">TEKKI STUDIO • Options d'Acquisition</span>
            </div>

            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
              Acquisition Progressive vs Complète
            </h1>
      ...
      <section className="py-12 bg-tekki-cream">
        <Container>
          <div className="max-w-4xl mx-auto bg-white rounded-xl p-6 md:p-8 border border-tekki-blue/8">
        ...
        <section className="py-16 bg-white">
          <Container>
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
              {/* Option standard */}
              <div className="bg-white rounded-xl hover:shadow-lg transition-all p-8 border border-tekki-blue/8 group">
                ...
                <div className="rounded-lg bg-tekki-cream p-4 mb-6 border border-tekki-blue/8">
              ...
              {/* Option progressive */}
              <div className="bg-white rounded-xl hover:shadow-lg transition-all p-8 border border-tekki-blue/8 relative group">
                <div className="absolute -right-3 top-6 rotate-45 bg-tekki-orange text-white px-12 py-1 text-sm font-medium z-10">
                  NOUVEAU
                </div>
                
                <div className="flex items-start mb-6">
                  <div className="w-16 h-16 bg-tekki-orange/10 rounded-full flex items-center justify-center mr-4 group-hover:bg-tekki-orange/20 transition-all">
                    <Rocket className="w-8 h-8 text-tekki-orange" />
                  </div>
                  <div>
                    <h3 className="text-2xl font-bold text-tekki-orange mb-1">Acquisition Progressive</h3>
                    <p className="text-gray-500">Transfert progressif en {MONTHS_DURATION} mois</p>
                  </div>
                </div>
                
                <div className="rounded-lg bg-tekki-cream p-4 mb-6 border border-tekki-blue/8">
                  <div className="text-xl font-bold text-tekki-orange">
                ...
                <Link 
                  ...
                  className="w-full bg-tekki-orange hover:bg-tekki-orange/90 text-white py-3 rounded-lg font-medium transition-colors flex items-center justify-center"
                >
          ...
          <Container>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="bg-white rounded-xl border border-tekki-blue/8 overflow-hidden">
                <div className="p-6 md:p-8">
                  ...
                  <div className="grid md:grid-cols-2 gap-8">
                    <div>
                      ...
                      <div className="space-y-6">
                        ...
                        <div>
                          ...
                          <div className="bg-tekki-cream rounded-lg p-4 space-y-3 border border-tekki-blue/8">
                    ...
                    <div className="bg-tekki-cream p-6 rounded-xl border border-tekki-blue/8">
                      <h3 className="text-xl font-semibold text-tekki-blue mb-6">
                        Résultats
                      </h3>
                      ...
                      <div className="mb-6">
                        ...
                        <div className="text-2xl font-bold text-tekki-orange">
              ...
              <div className="flex justify-center mt-8">
                <Link 
                  href="/business?acquisition=progressive"
                  className="bg-tekki-orange hover:bg-tekki-orange/90 text-white px-6 py-3 rounded-lg font-medium transition-colors flex items-center"
                >
          ...
          <Container>
            ...
            <div className="max-w-4xl mx-auto">
              {faqs.map((faq, index) => (
                <div
                  key={index}
                  className="bg-tekki-cream rounded-xl mb-4 last:mb-0 hover:shadow-md transition-all border border-tekki-blue/8 hover:border-tekki-orange/20 overflow-hidden"
                >
                  <details className="group">
                    <summary className="flex justify-between items-center cursor-pointer p-6">
                      ...
                      <div className="flex-shrink-0 text-gray-400 group-open:text-tekki-orange transition-colors">
